...
namespace RealtimeSample.Console.Utility;
...
/// input as a stream.
/// </summary>
public class ConsoleMicrophone : Stream, IDisposable
{
    ...
    private ConsoleMicrophone()
    {
        ...
        _waveInEvent.DataAvailable += (_, e) =>
        {
            lock (_bufferLock)
            {
                ...
                {
                    var bytesToCopyBeforeWrap = _buffer.Length - _bufferWritePos;
    ...
    public static ConsoleMicrophone Start() => new();
    ...
    public override int Read(byte[] buffer, int offset, int count)
    {
        ...
        lock (_bufferLock)
        {
            ...
            {
                var bytesBeforeWrap = _buffer.Length - _bufferReadPos;
                Array.Copy(
                    sourceArray: _buffer,
